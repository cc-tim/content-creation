---
name: scene-update
description: Use when the user asks to fix wording, narration text, overlays, or audio in a specific scene; when asking to enhance, rewrite, or tighten a scene's language; when asking to re-render, rescene, or rebuild individual scenes; when discussing what a scene says or how it sounds.
---
